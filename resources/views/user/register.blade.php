    ...
    <main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
        <section>
            ...
            <p class="text-gray-600 pt-2">
                Sign in you account <a href="/login" class="text-purple-800 font-bold">here</a>
            </p>
        </section>
        <section class="mt-10">
            <form action="/store1" method="post" class="flex flex-col">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label for="password_confirmation" class="block text-gray-700 text-sm font-bold mb-2 ml-3">Confrim Password</label>
                    <input type="password" name="password_confirmation" class="bg-gray-200 w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3">
